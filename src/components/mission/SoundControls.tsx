...
export default function SoundControls() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full flex items-center justify-center transition-colors duration-300"
      style={{
      ...
      whileHover={{
        scale: 1.1,
        boxShadow: soundEnabled
          ? '0 0 25px rgba(34, 211, 238, 0.4), 0 0 50px rgba(34, 211, 238, 0.15)'
